...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'bd94d9ef-c1e7-48b0-aacc-f2fd3f844d57' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('8fab3e3b-c432-408f-9002-a9e44471aa9f');
      cy.get(`[data-cy="name"]`).should('have.value', '8fab3e3b-c432-408f-9002-a9e44471aa9f');
