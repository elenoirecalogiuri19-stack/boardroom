...
type SaleFormGroupContent = {
  ...
  nome: FormControl<ISale['nome']>;
  capienza: FormControl<ISale['capienza']>;
  descrizione: FormControl<ISale['descrizione']>;
};
...
export class SaleFormService {
  createSaleFormGroup(sale: SaleFormGroupInput = { id: null }): SaleFormGroup {
    ...
    return new FormGroup<SaleFormGroupContent>({
      ...
      nome: new FormControl(saleRawValue.nome, {
        validators: [Validators.required],
      }),
      capienza: new FormControl(saleRawValue.capienza, {
        validators: [Validators.required],
      }),
      descrizione: new FormControl(saleRawValue.descrizione),
    });
  }
