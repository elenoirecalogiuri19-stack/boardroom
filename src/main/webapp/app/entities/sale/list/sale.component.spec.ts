...
describe('Sale Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '157c8880-42a9-4d24-b13f-c77ce41f45a7' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '40c7b91e-348d-42f3-85b7-68229c210645' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.sales()[0]).toEqual(expect.objectContaining({ id: '157c8880-42a9-4d24-b13f-c77ce41f45a7' }));
  });
